...
var TEMP_VAR_AUTOGEN9__RANDOM_LATER =  reflect( params )

var TIMING_TEMP_VAR_AUTOGEN9__RANDOM_LATER = perf_hooks.performance.now();
 console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/reflect/test/reflect.test.js& [184, 1; 184, 24]& TEMP_VAR_AUTOGEN9__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN9__RANDOM_LATER));
...
var TEMP_VAR_AUTOGEN10__RANDOM_LATER =  reflect( params )
...
fs.closeSync( fs.openSync( params.dest + '/.gitkeep', 'w' ) );
var TIMING_TEMP_VAR_AUTOGEN10__RANDOM_LATER = perf_hooks.performance.now();
 console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/reflect/test/reflect.test.js& [192, 1; 192, 24]& TEMP_VAR_AUTOGEN10__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN10__RANDOM_LATER));
 await TEMP_VAR_AUTOGEN10__RANDOM_LATER
...
var TEMP_VAR_AUTOGEN12__RANDOM =  reflect( params )

await write( params.src + '/file', 'content' )

	

var TIMING_TEMP_VAR_AUTOGEN12__RANDOM = perf_hooks.performance.now();
 var AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN12__RANDOM = await  TEMP_VAR_AUTOGEN12__RANDOM
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/reflect/test/reflect.test.js& [232, 1; 232, 45]& TEMP_VAR_AUTOGEN12__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN12__RANDOM));
 const { res, err } =   AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN12__RANDOM
...
var TEMP_VAR_AUTOGEN13__RANDOM =  reflect( params )
var TIMING_TEMP_VAR_AUTOGEN13__RANDOM = perf_hooks.performance.now();
 var AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN13__RANDOM = await  TEMP_VAR_AUTOGEN13__RANDOM
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/reflect/test/reflect.test.js& [261, 1; 261, 45]& TEMP_VAR_AUTOGEN13__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN13__RANDOM));
 const { res, err } =   AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN13__RANDOM
