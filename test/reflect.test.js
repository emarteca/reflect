...
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/reflect/test/reflect.test.js& [184, 1; 184, 24]& TEMP_VAR_AUTOGEN9__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN9__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN10__RANDOM = perf_hooks.performance.now();
 await  reflect( params )
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/reflect/test/reflect.test.js& [192, 1; 192, 24]& TEMP_VAR_AUTOGEN10__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN10__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN12__RANDOM = perf_hooks.performance.now();
 var AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN12__RANDOM = await  reflect( params )
...
var TIMING_TEMP_VAR_AUTOGEN13__RANDOM = perf_hooks.performance.now();
 var AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN13__RANDOM = await  reflect( params )
